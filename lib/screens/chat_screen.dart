...
import 'package:cloud_firestore/cloud_firestore.dart'; // NUEVO: Import para buscar el nombre
...
class ChatScreen extends StatefulWidget {
  ...
  final String otherUserId; // CAMBIO: Ahora recibimos el ID para buscar el nombre nosotros mismos
  final bool isWalker;
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendQuickAction(String actionText, String type) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error al enviar acción: $e')),
      );
    } finally {
      if (mounted) setState(() => _isSending = false);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // CORRECCIÓN: Usar FutureBuilder para obtener el nombre real dinámicamente
        title: FutureBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasData && snapshot.data!.exists) {
              ...
              // Busca el campo 'name' en el documento del usuario
